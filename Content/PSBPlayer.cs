	...
	public class PSBPlayer : ModPlayer
	{
		...
		public Dictionary<ArmorSet, ArmorSetParameters> InitialArmorData()
		{
			...
			return new Dictionary<ArmorSet, ArmorSetParameters>()
			{
				...
				{ArmorSet.BorealWood, new ArmorSetParameters { validHelmets = new int[] {ItemID.BorealWoodHelmet}, validChests = new int[] {ItemID.BorealWoodBreastplate}, validGreaves = new int[] {ItemID.BorealWoodGreaves}, maxXP = armorSettings.BorealEXP, textR = 107, textG = 86, textB = 71, bonusWeapons = new int[] {ItemID.BorealWoodSword, ItemID.BorealWoodBow, ItemID.BorealWoodHammer, ItemID.WoodYoyo}, enabled = armorSettings.EnableBorealWood}},
				{ArmorSet.PalmWood, new ArmorSetParameters { validHelmets = new int[] {ItemID.PalmWoodHelmet}, validChests = new int[] {ItemID.PalmWoodBreastplate}, validGreaves = new int[] {ItemID.PalmWoodGreaves}, maxXP = armorSettings.PalmEXP, textR = 182, textG = 141, textB = 86, bonusWeapons = new int[] {ItemID.PalmWoodBow, ItemID.PalmWoodSword, ItemID.PalmWoodHammer, ItemID.WoodYoyo}, enabled = armorSettings.EnablePalmWood}},
				{ArmorSet.RichMahogany, new ArmorSetParameters { validHelmets = new int[] {ItemID.RichMahoganyHelmet}, validChests = new int[] {ItemID.RichMahoganyBreastplate}, validGreaves = new int[] {ItemID.RichMahoganyGreaves}, maxXP = armorSettings.MahoganyEXP, textR = 163, textG = 99, textB = 104, bonusWeapons = new int[] {ItemID.RichMahoganyBow, ItemID.RichMahoganySword, ItemID.RichMahoganyHammer, ItemID.WoodYoyo}, enabled = armorSettings.EnableMahogany}},
				{ArmorSet.Copper, new ArmorSetParameters { validHelmets = new int[] {ItemID.CopperHelmet}, validChests = new int[] {ItemID.CopperChainmail}, validGreaves = new int[] {ItemID.CopperGreaves}, maxXP = armorSettings.CopperEXP, textR = 255, textG = 146, textB = 97, bonusWeapons = new int[] {ItemID.CopperAxe, ItemID.CopperBow, ItemID.CopperHammer, ItemID.CopperPickaxe, ItemID.CopperShortsword, ItemID.CopperBroadsword, ItemID.AmethystStaff}, enabled = armorSettings.EnableCopper}},
				{ArmorSet.Tin, new ArmorSetParameters { validHelmets = new int[] {ItemID.TinHelmet}, validChests = new int[] {ItemID.TinChainmail}, validGreaves = new int[] {ItemID.TinGreaves}, maxXP = armorSettings.TinEXP, textR = 228, textG = 219, textB = 162, bonusWeapons = new int[] {ItemID.TinAxe, ItemID.TinBow, ItemID.TinHammer, ItemID.TinPickaxe, ItemID.TinShortsword, ItemID.TinBroadsword, ItemID.TopazStaff}, enabled = armorSettings.EnableTin}},
				{ArmorSet.Iron, new ArmorSetParameters { validHelmets = new int[] {ItemID.IronHelmet, ItemID.AncientIronHelmet}, validChests = new int[] {ItemID.IronChainmail}, validGreaves = new int[] {ItemID.IronGreaves}, maxXP = armorSettings.IronEXP, textR = 181, textG = 164, textB = 149, bonusWeapons = new int[] {ItemID.IronAxe, ItemID.IronBow, ItemID.IronPickaxe, ItemID.IronHammer, ItemID.IronShortsword, ItemID.IronBroadsword}, enabled = armorSettings.EnableIron}},
				{ArmorSet.Lead, new ArmorSetParameters { validHelmets = new int[] {ItemID.LeadHelmet}, validChests = new int[] {ItemID.LeadChainmail}, validGreaves = new int[] {ItemID.LeadGreaves}, maxXP = armorSettings.LeadEXP, textR = 142, textG = 161, textB = 158, bonusWeapons = new int[] {ItemID.LeadBow, ItemID.LeadAxe, ItemID.LeadPickaxe, ItemID.LeadHammer, ItemID.LeadShortsword, ItemID.LeadBroadsword}, enabled = armorSettings.EnableLead}},
				{ArmorSet.Ebonwood, new ArmorSetParameters { validHelmets = new int[] {ItemID.EbonwoodHelmet}, validChests = new int[] {ItemID.EbonwoodBreastplate}, validGreaves = new int[] {ItemID.EbonwoodGreaves}, maxXP = armorSettings.EbonEXP, textR = 153, textG = 137, textB = 165, bonusWeapons = new int[] {ItemID.EbonwoodBow, ItemID.EbonwoodHammer, ItemID.EbonwoodSword, ItemID.WoodYoyo}, enabled = armorSettings.EnableEbonwood}},
				{ArmorSet.Shadewood, new ArmorSetParameters { validHelmets = new int[] {ItemID.ShadewoodHelmet}, validChests = new int[] {ItemID.ShadewoodBreastplate}, validGreaves = new int[] {ItemID.ShadewoodGreaves}, maxXP = armorSettings.ShadeEXP, textR = 117, textG = 134, textB = 149, bonusWeapons = new int[] {ItemID.ShadewoodBow, ItemID.ShadewoodHammer, ItemID.ShadewoodSword, ItemID.WoodYoyo}, enabled = armorSettings.EnableShadewood}},
				{ArmorSet.Silver, new ArmorSetParameters { validHelmets = new int[] {ItemID.SilverHelmet}, validChests = new int[] {ItemID.SilverChainmail}, validGreaves = new int[] {ItemID.SilverGreaves}, maxXP = armorSettings.SilverEXP, textR = 171, textG = 182, textB = 183, bonusWeapons = new int[] {ItemID.SilverAxe, ItemID.SilverPickaxe, ItemID.SilverHammer, ItemID.SilverBow, ItemID.SilverShortsword, ItemID.SilverBroadsword, ItemID.SapphireStaff}, enabled = armorSettings.EnableSilver}},
				{ArmorSet.Tungsten, new ArmorSetParameters { validHelmets = new int[] {ItemID.TungstenHelmet}, validChests = new int[] {ItemID.TungstenChainmail}, validGreaves = new int[] {ItemID.TungstenGreaves}, maxXP = armorSettings.TungstenEXP, textR = 202, textG = 233, textB = 207, bonusWeapons = new int[] {ItemID.TungstenAxe, ItemID.TungstenPickaxe, ItemID.TungstenHammer, ItemID.TungstenBow, ItemID.TungstenShortsword, ItemID.TungstenBroadsword, ItemID.EmeraldStaff}, enabled = armorSettings.EnableTungsten}},
				{ArmorSet.Gold, new ArmorSetParameters { validHelmets = new int[] {ItemID.GoldHelmet, ItemID.AncientGoldHelmet}, validChests = new int[] {ItemID.GoldChainmail}, validGreaves = new int[] {ItemID.GoldGreaves}, maxXP = armorSettings.GoldEXP, textR = 255, textG = 249, textB = 183, bonusWeapons = new int[] {ItemID.GoldAxe, ItemID.GoldPickaxe, ItemID.GoldHammer, ItemID.GoldBow, ItemID.GoldShortsword, ItemID.GoldBroadsword, ItemID.FlinxStaff, ItemID.RubyStaff}, enabled = armorSettings.EnableGold}},
				{ArmorSet.Platinum, new ArmorSetParameters { validHelmets = new int[] {ItemID.PlatinumHelmet}, validChests = new int[] {ItemID.PlatinumChainmail}, validGreaves = new int[] {ItemID.PlatinumGreaves}, maxXP = armorSettings.PlatinumEXP, textR = 246, textG = 216, textB = 235, bonusWeapons = new int[] {ItemID.PlatinumAxe, ItemID.PlatinumPickaxe, ItemID.PlatinumHammer, ItemID.PlatinumBow, ItemID.PlatinumShortsword, ItemID.PlatinumBroadsword, ItemID.FlinxStaff, ItemID.DiamondStaff}, enabled = armorSettings.EnablePlatinum}},
				{ArmorSet.Cactus, new ArmorSetParameters {validHelmets = new int[] {ItemID.CactusHelmet}, validChests = new int[] {ItemID.CactusBreastplate}, validGreaves = new int[] {ItemID.CactusLeggings}, maxXP = armorSettings.CactusEXP, textR = 120, textG = 250, textB = 120, bonusWeapons = new int[] {ItemID.CactusPickaxe, ItemID.CactusSword}, enabled = armorSettings.EnableCactus}},
				{ArmorSet.Pumpkin, new ArmorSetParameters {validHelmets = new int[] {ItemID.PumpkinHelmet}, validChests = new int[] {ItemID.PumpkinBreastplate}, validGreaves = new int[] {ItemID.PumpkinLeggings}, maxXP = armorSettings.PumpkinEXP, textR = 200, textG = 150, textB = 100, bonusWeapons = new int[] {ItemID.TheHorsemansBlade, ItemID.JackOLanternLauncher}, enabled = armorSettings.EnablePumpkin}},
				{ArmorSet.Ninja, new ArmorSetParameters {validHelmets = new int[] {ItemID.NinjaHood}, validChests = new int[] {ItemID.NinjaShirt}, validGreaves = new int[] {ItemID.NinjaPants}, maxXP = armorSettings.NinjaEXP, textR = 190, textG = 190, textB = 200, bonusWeapons = new int[] {ItemID.SlimeGun, ItemID.SlimeStaff, ItemID.Shuriken, ItemID.Katana}, enabled = armorSettings.EnableNinja}},
				{ArmorSet.Wizard, new ArmorSetParameters {validHelmets = new int[] {ItemID.WizardHat, ItemID.MagicHat}, validChests = new int[] {ItemID.AmethystRobe, ItemID.TopazRobe, ItemID.SapphireRobe, ItemID.EmeraldRobe, ItemID.RubyRobe, ItemID.AmberRobe, ItemID.DiamondRobe, ItemID.GypsyRobe}, validGreaves = new int[] {}, maxXP = armorSettings.WizardEXP, textR = 250, textG = 250, textB = 250, bonusWeapons = new int[] {ItemID.AmethystStaff, ItemID.TopazStaff, ItemID.SapphireStaff, ItemID.EmeraldStaff, ItemID.RubyStaff, ItemID.AmberStaff, ItemID.DiamondStaff}, enabled = armorSettings.EnableWizard}},
				{ArmorSet.Fossil, new ArmorSetParameters {validHelmets = new int[] {ItemID.FossilHelm}, validChests = new int[] {ItemID.FossilShirt}, validGreaves = new int[] {ItemID.FossilPants}, maxXP = armorSettings.FossilEXP, textR = 200, textG = 170, textB = 100, bonusWeapons = new int[] {ItemID.AmberStaff, ItemID.BoneJavelin, ItemID.BoneDagger, ItemID.FossilPickaxe}, enabled = armorSettings.EnableFossil}},
				{ArmorSet.Meteor, new ArmorSetParameters {validHelmets = new int[] {ItemID.MeteorHelmet}, validChests = new int[] {ItemID.MeteorSuit}, validGreaves = new int[] {ItemID.MeteorLeggings}, maxXP = armorSettings.MeteorEXP, textR = 255, textG = 126, textB = 9, bonusWeapons = new int[] {ItemID.BluePhaseblade, ItemID.GreenPhaseblade, ItemID.MeteorHamaxe, ItemID.MeteorStaff, ItemID.OrangePhaseblade, ItemID.PurplePhaseblade, ItemID.RedPhaseblade, ItemID.SpaceGun, ItemID.StarCannon, ItemID.WhitePhaseblade, ItemID.YellowPhaseblade}, enabled = armorSettings.EnableMeteor}},
