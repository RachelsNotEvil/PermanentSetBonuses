...
namespace PermanentSetBonuses.Content
{
	...
	public class PSBPlayer : ModPlayer
	{
		...
		public Dictionary<ArmorSet, ArmorSetParameters> InitialArmorData()
		{
			...
			{
				{ArmorSet.Wood, new ArmorSetParameters { validHelmets = new int[] {ItemID.WoodHelmet}, validChests = new int[] {ItemID.WoodBreastplate}, validGreaves = new int[] {ItemID.WoodGreaves}, maxXP = 500, currentXP = 0, textR = 151, textG = 107, textB = 75, bonusWeapons = new int[] {ItemID.WoodenSword, ItemID.WoodenBow, ItemID.WoodenHammer}, enabled = true}},
				{ArmorSet.BorealWood, new ArmorSetParameters { validHelmets = new int[] {ItemID.BorealWoodHelmet}, validChests = new int[] {ItemID.BorealWoodBreastplate}, validGreaves = new int[] {ItemID.BorealWoodGreaves}, maxXP = 550, currentXP = 0, textR = 107, textG = 86, textB = 71, bonusWeapons = new int[] {ItemID.BorealWoodSword, ItemID.BorealWoodBow, ItemID.BorealWoodHammer}, enabled = true}},
				{ArmorSet.PalmWood, new ArmorSetParameters { validHelmets = new int[] {ItemID.PalmWoodHelmet}, validChests = new int[] {ItemID.PalmWoodBreastplate}, validGreaves = new int[] {ItemID.PalmWoodGreaves}, maxXP = 550, currentXP = 0, textR = 182, textG = 141, textB = 86, bonusWeapons = new int[] {ItemID.PalmWoodBow, ItemID.PalmWoodSword, ItemID.PalmWoodHammer}, enabled = true}},
				{ArmorSet.RichMahogany, new ArmorSetParameters { validHelmets = new int[] {ItemID.RichMahoganyHelmet}, validChests = new int[] {ItemID.RichMahoganyBreastplate}, validGreaves = new int[] {ItemID.RichMahoganyGreaves}, maxXP = 575, currentXP = 0, textR = 163, textG = 99, textB = 104, bonusWeapons = new int[] {ItemID.RichMahoganyBow, ItemID.RichMahoganySword, ItemID.RichMahoganyHammer}, enabled = true}},
				{ArmorSet.Copper, new ArmorSetParameters { validHelmets = new int[] {ItemID.CopperHelmet}, validChests = new int[] {ItemID.CopperChainmail}, validGreaves = new int[] {ItemID.CopperGreaves}, maxXP = 750, currentXP = 0, textR = 255, textG = 146, textB = 97, bonusWeapons = new int[] {ItemID.CopperAxe, ItemID.CopperBow, ItemID.CopperHammer, ItemID.CopperPickaxe, ItemID.CopperShortsword, ItemID.CopperBroadsword, ItemID.AmethystStaff}, enabled = true}},
				{ArmorSet.Tin, new ArmorSetParameters { validHelmets = new int[] {ItemID.TinHelmet}, validChests = new int[] {ItemID.TinChainmail}, validGreaves = new int[] {ItemID.TinGreaves}, maxXP = 800, currentXP = 0, textR = 228, textG = 219, textB = 162, bonusWeapons = new int[] {ItemID.TinAxe, ItemID.TinBow, ItemID.TinHammer, ItemID.TinPickaxe, ItemID.TinShortsword, ItemID.TinBroadsword, ItemID.TopazStaff}, enabled = true}},
				{ArmorSet.Iron, new ArmorSetParameters { validHelmets = new int[] {ItemID.IronHelmet, ItemID.AncientIronHelmet}, validChests = new int[] {ItemID.IronChainmail}, validGreaves = new int[] {ItemID.IronGreaves}, maxXP = 1000, currentXP = 0, textR = 181, textG = 164, textB = 149, bonusWeapons = new int[] {ItemID.IronAxe, ItemID.IronBow, ItemID.IronPickaxe, ItemID.IronHammer, ItemID.IronShortsword, ItemID.IronBroadsword}, enabled = true}},
				{ArmorSet.Lead, new ArmorSetParameters { validHelmets = new int[] {ItemID.LeadHelmet}, validChests = new int[] {ItemID.LeadChainmail}, validGreaves = new int[] {ItemID.LeadGreaves}, maxXP = 1250, currentXP = 0, textR = 142, textG = 161, textB = 158, bonusWeapons = new int[] {ItemID.LeadBow, ItemID.LeadAxe, ItemID.LeadPickaxe, ItemID.LeadHammer, ItemID.LeadShortsword, ItemID.LeadBroadsword}, enabled = true}},
				{ArmorSet.Ebonwood, new ArmorSetParameters { validHelmets = new int[] {ItemID.EbonwoodHelmet}, validChests = new int[] {ItemID.EbonwoodBreastplate}, validGreaves = new int[] {ItemID.EbonwoodGreaves}, maxXP = 700, currentXP = 0, textR = 153, textG = 137, textB = 165, bonusWeapons = new int[] {ItemID.EbonwoodBow, ItemID.EbonwoodHammer, ItemID.EbonwoodSword}, enabled = true}},
				{ArmorSet.Shadewood, new ArmorSetParameters { validHelmets = new int[] {ItemID.ShadewoodHelmet}, validChests = new int[] {ItemID.ShadewoodBreastplate}, validGreaves = new int[] {ItemID.ShadewoodGreaves}, maxXP = 700, currentXP = 0, textR = 117, textG = 134, textB = 149, bonusWeapons = new int[] {ItemID.ShadewoodBow, ItemID.ShadewoodHammer, ItemID.ShadewoodSword}, enabled = true}},
