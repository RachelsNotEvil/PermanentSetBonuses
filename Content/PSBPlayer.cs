	...
	public class PSBPlayer : ModPlayer
	{
		...
		public Dictionary<ArmorSet, ArmorSetParameters> InitialArmorData()
		{
			return new Dictionary<ArmorSet, ArmorSetParameters>()
			{
				...
				{ArmorSet.Ebonwood, new ArmorSetParameters { validHelmets = new int[] {ItemID.EbonwoodHelmet}, validChests = new int[] {ItemID.EbonwoodBreastplate}, validGreaves = new int[] {ItemID.EbonwoodGreaves}, maxXP = 700, textR = 153, textG = 137, textB = 165, bonusWeapons = new int[] {ItemID.EbonwoodBow, ItemID.EbonwoodHammer, ItemID.EbonwoodSword, ItemID.WoodYoyo}, enabled = true}},
